                            ...
                            <div class="activity-log d-flex mb-4">
                                <div class="switch w-25">
                                    ...
                                    <div class="position-relative">
                                        <label>
                                            Off
                                            <input type="hidden" id="activityLog" name="activity_log" value="0">
                                            <input type="checkbox" id="activityLog" name="activity_log" value="1">
                                ...
                                <div class="mt-4 activity_check">
                                    <fieldset class="form-check">
                                        <input name="activity_delete" class="form-check-input" type="hidden" id="deleteLog" value="0">
                            ...
                            <div class="user-access d-flex mb-4">
                                <div class="switch w-25">
                                    ...
                                    <div class="pY-4 position-relative">
                                        <label>
                                            Off
                                            <input name="user_access" id="userAccess" type="hidden" value="0">
                                            <input name="user_access" id="userAccess" type="checkbox" value="1">
                                            <span class="lever"></span> On
                                        </label>
                                    </div>
                                </div>
                                <div class="mt-4 user_check">
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="user_add" type="hidden" id="addUser" value="0">
                                ...
                                <div class="mt-4 user_check">
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="user_edit" type="hidden" id="modifyUser" value="0">
                                ...
                                <div class="mt-4 user_check">
                                    <fieldset class="form-check">
                                        <input class="form-check-input name=user_delete" type="hidden" id="deleteUser" value="0">
                            ...
                            <div class="user-access d-flex mb-4">
                                <div class="switch w-25">
                                    ...
                                    <div class="pY-4 position-relative">
                                        <label>
                                            Off
                                            <input name="role_access" id="userAccess" type="hidden" value="0">
                                            <input name="role_access" id="userAccess" type="checkbox" value="1">
                                            <span class="lever"></span> On
                                        </label>
                                    </div>
                                </div>
                                <div class="mt-4 role-check">
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="role_add" type="hidden" id="addRole" value="0">
                                ...
                                <div class="mt-4 role-check">
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="role_edit" type="hidden" id="modifyRole" value="0">
                                ...
                                <div class="mt-4 role-check">
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="role_delete" type="hidden" id="deleteRole" value="0">
                            ...
                            <div class="user-access d-flex">
                                <div class="switch w-25">
                                    ...
                                    <div class="pY-4 position-relative">
                                        <label>
                                            Off
                                            <input name="setting_access" id="settingAccess" type="hidden" value="0">
                                            <input name="setting_access" id="settingAccess" type="checkbox" value="1">
                                            <span class="lever"></span> On
                                        </label>
                                    </div>
                                </div>
